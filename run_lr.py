...
print('Logistic Regression without SMOTE - Accuracy: ', results['accuracy'])
print('Logistic Regression without SMOTE - Precision: ', results['precision'])
print('Logistic Regression without SMOTE - Recall: ', results['recall'])
print('Logistic Regression without SMOTE - F-Score: ', results['fScore'])
...
print('Logistic Regression with imp features & SMOTE - Accuracy: ',results['accuracy'])
print('Logistic Regression with imp features & SMOTE - Precision: ',results['precision'])
print('Logistic Regression with imp features & SMOTE - Recall: ',results['recall'])
print('Logistic Regression with imp features & SMOTE - F-Score: ',results['fScore'])
